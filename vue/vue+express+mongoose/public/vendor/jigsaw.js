...
(function (window) {
  ...
  function getRandomImg() {
    ...
    return '../image/jigsaw/' + getRandomNumberByRange(1, 10)+'.jpg';
  }
  ...
  var jigsaw = function () {
    ...
    _createClass(jigsaw, [{
      ...
      value: function initDOM() {
        ...
        var refreshIcon = createElement('i', 'refreshIcon el-icon-refresh-right');
        var sliderMask = createElement('div', 'sliderMask');
        var slider = createElement('div', 'slider');
        var sliderIcon = createElement('i', 'sliderIcon el-icon-right');
...
function init2(){
  jigsaw.init({
    ...
    onSuccess: function() {
      document.getElementById('msg2').innerHTML = '验证成功！'
    },
    onFail: cleanMsg2,
    onRefresh: cleanMsg2
  })
